...
ANALYST_NODE_SPECS: Dict[str, AnalystNodeSpec] = {
    ...
    "quant": AnalystNodeSpec(
        key="quant",
        agent_node="Quant Prediction Agent",
    ...
    "geographic": AnalystNodeSpec(
        key="geographic",
        agent_node="Geographic Impact Agent",
        clear_node="Msg Clear Geographic",
        tool_node="tools_geographic",
        report_key="geographic_report",
    ),
}
