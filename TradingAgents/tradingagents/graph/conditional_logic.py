...
class ConditionalLogic:
    ...
    def should_continue_geographic(self, state: AgentState):
        """Determine if geographic analysis should continue."""
        messages = state["messages"]
        last_message = messages[-1]
        if last_message.tool_calls:
            return "tools_geographic"
        return "Msg Clear Geographic"
